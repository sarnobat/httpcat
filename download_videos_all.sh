...
touch ~/sarnobat.git/db/auto/yurl_queue_httpcat_videos_downloaded.txt ;  comm -23 <(sort ~/sarnobat.git/db/auto/yurl_queue_httpcat_videos.txt)  <(sort ~/sarnobat.git/db/auto/yurl_queue_httpcat_videos_downloaded.txt) | grep -v channel | tac | tee /tmp/yurl_queue_httpcat_videos_undownloaded.txt
...
touch ~/sarnobat.git/db/auto/yurl_queue_httpcat_videos_downloaded.txt ; cat ~/sarnobat.git/db/auto/yurl_queue_httpcat_videos.txt | grep -v -f ~/sarnobat.git/db/auto/yurl_queue_httpcat_videos_downloaded.txt | grep -v channel | tac | tee /tmp/yurl_queue_httpcat_videos_undownloaded.txt
